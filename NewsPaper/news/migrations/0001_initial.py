    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profiles', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_content', models.CharField(choices=[('ART', 'Статья'), ('NWS', 'Новость')], default='NWS', max_length=3)),
